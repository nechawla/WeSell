...
<div class="txt-heading">Orders: </div>
	<br/>
    <br/>
<p><?=$total_products?> complaints have been raised </p>
<br/>
<br/>
  <table class="tbl-cart" cellpadding="10" cellspacing="2">
  <tbody>
  <tr>
  <th style="text-align:left;" width="3%">User submitted</th>
  <th style="text-align:left;" width="10%">Email</th>
  <th style="text-align:left;" width="10%">Message</th>
  <th style="text-align:left;" width="5%">Date Submitted</th>
          ...
          <?php foreach ($result as $item): ?>
                ...
                <td style="text-align:left;"><?php echo $item["message"]; ?></td>
                <td style="text-align:left;"><?php echo $item["dateSubmitted"]; ?></td>
